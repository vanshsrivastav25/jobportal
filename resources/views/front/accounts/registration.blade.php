...
$("#registrationForm").submit(function(e){
    ...
    $.ajax({
        url: '{{ route("accounts.processRegistration") }}', // Laravel route
        type: 'post',
        data: $("#registrationForm").serializeArray(), // Form data bhejna
        dataType: 'json',
        success: function(response) {
            if (response.status == false) {
                var errors = response.errors; // Backend se aaye validation errors
